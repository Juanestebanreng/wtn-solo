...
const partySchema = z
  .object({
    ...
    role_producer: z.coerce.boolean().optional(),
    role_importer: z.coerce.boolean().optional(),
    role_local_authority: z.coerce.boolean().optional(),
    role_permit_holder: z.coerce.boolean().optional(),
    permit_number: z.string().optional(),
    role_exemption_holder: z.coerce.boolean().optional(),
    exemption_details: z.string().optional(),
    role_carrier: z.coerce.boolean().optional(),
    role_broker: z.coerce.boolean().optional(),
    role_dealer: z.coerce.boolean().optional(),
